...
const RoboticArm = {
    ...
    init() {
        console.log('Initializing RoboticArm simulation...');
        this.canvas = document.getElementById('robotic-arm-canvas');
        if (!this.canvas) {
            console.error('RoboticArm: Canvas not found!');
            return;
        }
        console.log('RoboticArm: Canvas found, initializing...');
        this.ctx = this.canvas.getContext('2d');
        this.resizeCanvas();
        this.createArmSegments();
        this.animate();
        console.log('RoboticArm: Initialization complete');
    },
...
const CFDSimulation = {
    ...
    init() {
        console.log('Initializing CFDSimulation (Navier-Stokes)...');
        this.canvas = document.getElementById('cfd-canvas');
        if (!this.canvas) {
            console.error('CFDSimulation: Canvas not found!');
            return;
        }
        console.log('CFDSimulation: Canvas found, initializing...');
        this.ctx = this.canvas.getContext('2d');
        this.resizeCanvas();
        ...
        this.createVortices();
        this.animate();
        console.log('CFDSimulation: Initialization complete');
    },
...
const ThrusterSimulation = {
    ...
    init() {
        console.log('Initializing ThrusterSimulation...');
        this.canvas = document.getElementById('thruster-canvas');
        if (!this.canvas) {
            console.error('ThrusterSimulation: Canvas not found!');
            return;
        }
        console.log('ThrusterSimulation: Canvas found, initializing...');
        this.ctx = this.canvas.getContext('2d');
        this.resizeCanvas();
        ...
        this.animate();
        console.log('ThrusterSimulation: Initialization complete');
    },
...
const CodeRain = {
    ...
    init() {
        console.log('Initializing CodeRain simulation...');
        this.canvas = document.getElementById('code-rain-canvas');
        if (!this.canvas) {
            console.error('CodeRain: Canvas not found!');
            return;
        }
        console.log('CodeRain: Canvas found, initializing...');
        this.ctx = this.canvas.getContext('2d');
        this.resizeCanvas();
        this.initializeStreams();
        this.animate();
        console.log('CodeRain: Initialization complete');
    },
